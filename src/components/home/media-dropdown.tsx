...
const MediaDropdown = () => {
    ...
    const { selectedConversation } = useConversationStore();//This function specifies the conversation selected

    //The below fct handles the process of uploading an img  and save it in the URL
    const handleSendImage = async () => {
        setIsLoading(true);//: Sets a loading state to true, which could be used to show a loading spinner or disable UI elements while the image is being processed.
        try {
